...
Usa estos bloques tal cual en los mismos archivos para que el backend (ESM) se conecte bien a SQLite desde cualquier carpeta y el frontend funcione con el login y el historial clínico con fotos antes/después.
...
## backend/routes/especialistas.js
```javascript
import express from "express";
import sqlite3 from "sqlite3";
import bodyParser from "body-parser";
