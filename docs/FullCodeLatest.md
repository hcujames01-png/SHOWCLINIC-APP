# Código completo actualizado (backend y frontend)

Usa estos bloques tal cual para que el backend levante con SQLite en cualquier ruta y el frontend se conecte correctamente.
